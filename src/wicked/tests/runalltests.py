...
$Id: runalltests.py 30382 2005-05-18 14:02:32Z shh $
"""
...
def test_finder(recurse, dired, names):
    if dired == os.curdir or '__init__.py' in names:
        parts = [x for x in dired[len(os.curdir):].split(os.sep) if x]
