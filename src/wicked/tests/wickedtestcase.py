...
from wicked.Extensions.Install import install as installWicked

# monkey patch config into ironicwiki schema
from wicked.example.ironicwiki import schema
schema['body'].wicked_macro='wicked_test'

import wicked.config as config
from wicked.utils import parseDepends, doc_file
from wicked.api import titleToNormalizedId
...
def setupCA():
    ...
    fivezcml.zcml.load_config('configure.zcml', wicked)
