...
def initialize(context):
    ...
    ModuleSecurityInfo('wicked.lib.normalize').declarePublic('titleToNormalizedId')
    allow_module('wicked.lib.normalize')
    allow_module('pdb')
    
    ModuleSecurityInfo('wicked.config').declarePublic('BACKLINK_RELATIONSHIP')
    allow_module('wicked.config')
